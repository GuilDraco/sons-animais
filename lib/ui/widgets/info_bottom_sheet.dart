...
class InfoBottomSheet extends StatefulWidget {
  ...
  const InfoBottomSheet({Key? key, required this.animal, required this.audioPlayer}) : super(key: key);
...
class _InfoBottomSheetState extends State<InfoBottomSheet> with ChangeNotifier {
  ...
  Future<void> tocarPararMusica() async {
    if (musicPlayng) {
      ...
      await widget.audioPlayer.play(AssetSource(widget.animal.audio));
      musicPlayng = true;
    }
    setState(() {});
  }
